...
- A deep base is the screen's newest alert kind: 25-35% deep, blue sky, 8 weeks or longer, emailed when the close clears the pivot by 2% or more on 1.5x volume. The grade rules stop at 25% depth, and the study of that excluded band found it pays better and fails more: 52% positive 20 bars on with 50% touching the fail level and 32% running +20% within 60 bars, against 56%, 28% and 14% for graded breakouts. A decisive clearance is what sorts the band: closes within 2% of the pivot ran 1.79, 5-10% past it ran 2.83. Say that trade-off plainly whenever one comes up, and note that the 20% trail matters most on this kind because the payoff is in the tail.
