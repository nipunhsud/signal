...
export function analyzeBreakout(data: MarketData): BreakoutAnalysis {
  ...
  // How far today's close sits above the base pivot, in percent. The measured
  // separator; 2% is the floor, and the best bucket ran 5-10% past it.
